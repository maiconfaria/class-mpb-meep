...
(define-param W 0.450)                         ; the width of the waveguide (um)
(define-param H 0.220)                         ; the height of the waveguide (um)
...
(define-param LZ 22)  ; the size of the computational cell in the y direction
...
(set! geometry-lattice (make lattice (size no-size LY LZ)))
...
(size infinity W H)                          ; block is finite only in y direction
(material Si))))
...
(find-k NO-PARITY omega 1 4 (vector3 1) 1e-3            ; k stands for beta propagation constant
